...
def build_braille_ascii_svg(ascii_str, output_path="avi-ascii.svg", width=370):
    ...
    svg_height = 360  # Aligned height with info card
    ...
    for r in range(rows):
        ...
        svg_lines.append(f'    <rect x="{padding_x:.1f}" y="{start_y + r * line_height - 12:.1f}" width="0" height="{line_height + 4}">')
    ...
    print(f"Successfully generated clean Braille ASCII SVG at {output_path}")
